...
#define ACCEL_STEP (float)(2.0) //default acceleration step
...
/* Jerk search params */
#define JERK_STEP 20 // Stepsize in Fourier F-dot-dot 
#define JERK_STEP_R 0.05 //Reciprocal of JERK_STEP

/* FDAS GPU grid params */
#define TBSIZEX 32
#define TBSIZEY 1
#define PTBSIZEX 64
#define PTBSIZEY 1
