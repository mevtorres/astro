#ifndef ASTRO_ACCELERATE_AA_PERMITTED_PIPELINES_JN_HPP
#define ASTRO_ACCELERATE_AA_PERMITTED_PIPELINES_JN_HPP
...
namespace astroaccelerate {
  ...
  /**
   * \class aa_permitted_pipelines_JN aa_permitted_pipelines_JN.hpp "include/aa_permitted_pipelines_JN.hpp"
  ...
  class aa_permitted_pipelines_jn : public aa_pipeline_runner {
  public:
    aa_permitted_pipelines_jn(const aa_ddtr_strategy &ddtr_strategy,
			     const aa_analysis_strategy &analysis_strategy,
			     unsigned short const*const input_buffer);
    
    ~aa_permitted_pipelines_jn() {
    ...
    aa_permitted_pipelines_jn(const aa_permitted_pipelines_jn &) = delete;
  ...
  private:
    ...
    bool run_pipeline(const bool dump_to_disk, const bool dump_to_user, std::vector<analysis_output> &user_output, aa_pipeline_runner::status &status_code) {
      printf("NOTICE: Pipeline start/resume run_pipeline_JN.\n");
      if(t >= num_tchunks) {
	m_timer.Stop();
	...
	oldBin = inBin[dm_range];
      ...
      ++t;
      printf("NOTICE: Pipeline ended run_pipeline_jn over chunk %d / %d.\n", t, num_tchunks);
      status_code = aa_pipeline_runner::status::has_more;
      return true;
    }    
  };

  template<> inline aa_permitted_pipelines_jn<aa_pipeline::component_option::zero_dm, false>::aa_permitted_pipelines_jn(const aa_ddtr_strategy &ddtr_strategy,
														  const aa_analysis_strategy &analysis_strategy,
  ...
  template<> inline aa_permitted_pipelines_jn<aa_pipeline::component_option::zero_dm, true>::aa_permitted_pipelines_jn(const aa_ddtr_strategy &ddtr_strategy,
														 const aa_analysis_strategy &analysis_strategy,
														 unsigned short const*const input_buffer) : m_ddtr_strategy(ddtr_strategy),
																			    m_analysis_strategy(analysis_strategy),
																			    m_input_buffer(input_buffer),
  ...
  template<> inline aa_permitted_pipelines_jn<aa_pipeline::component_option::zero_dm_with_outliers, false>::aa_permitted_pipelines_jn(const aa_ddtr_strategy &ddtr_strategy,
																const aa_analysis_strategy &analysis_strategy,
																unsigned short const*const input_buffer) : m_ddtr_strategy(ddtr_strategy),
																					   m_analysis_strategy(analysis_strategy),
																					   m_input_buffer(input_buffer),
  ...
  template<> inline aa_permitted_pipelines_jn<aa_pipeline::component_option::zero_dm_with_outliers, true>::aa_permitted_pipelines_jn(const aa_ddtr_strategy &ddtr_strategy,
															       const aa_analysis_strategy &analysis_strategy,
															       unsigned short const*const input_buffer) : m_ddtr_strategy(ddtr_strategy),
																					  m_analysis_strategy(analysis_strategy),
																					  m_input_buffer(input_buffer),
  ...
  template<> inline aa_permitted_pipelines_jn<aa_pipeline::component_option::empty, true>::aa_permitted_pipelines_jn(const aa_ddtr_strategy &ddtr_strategy,
													       const aa_analysis_strategy &analysis_strategy,
													       unsigned short const*const input_buffer) : m_ddtr_strategy(ddtr_strategy),
																			  m_analysis_strategy(analysis_strategy),
																			  m_input_buffer(input_buffer),
  ...
  template<> inline aa_permitted_pipelines_jn<aa_pipeline::component_option::empty, false>::aa_permitted_pipelines_jn(const aa_ddtr_strategy &ddtr_strategy,
														const aa_analysis_strategy &analysis_strategy,
														unsigned short const*const input_buffer) : m_ddtr_strategy(ddtr_strategy),
																			   m_analysis_strategy(analysis_strategy),
																			   m_input_buffer(input_buffer),
...
#endif // ASTRO_ACCELERATE_AA_PERMITTED_PIPELINES_JN_HPP
